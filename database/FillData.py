...
def insert():
    ...
    cursor.executemany("""
            ...
            """, [
                ...
                ('CSCI 159','Computer Science I','A first year course in computer science. Topics include structured programming, top-down program design, procedures, recursion, and an introduction to dynamic data structures.', 0, 0,'All Sections', 1,'Both'),
